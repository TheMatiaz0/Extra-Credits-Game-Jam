...
namespace Cyberultimate.Unity
{
    ...
    {
        public static Vector2 GetStronger(this Vector2 original)
        {
            Vector2 changer;
        ...
        public static Vector2 InvertStronger(this Vector2 original)
        {
            Vector2 changer;
            if (Math.Abs(original.x) < Math.Abs(original.y))
            {
        ...
        public static Vector2 Rotate(this Vector2 vect, Quaternion quaternion)
        {
            return Rotate(vect, quaternion.eulerAngles.z);
        }
