...
namespace Cyberultimate.Utility
{
		...
		where T:IComparable<T>
    {
		...
		{
			return MathHelper.GeneralCheckedAdd<T>(a, b, SimpleAdd, SimpleRemove, Max);
		}
		...
		{
			return MathHelper.GeneralCheckedRemove<T>(a, b, SimpleRemove, Min);
		}
	}
