	...
	public override void Activate()
	{
		...
		switch(rnd)
		{
			case 0:
				...
				TimeManager.Instance.StartTime = new System.TimeSpan(8, 0, 0);
				break;
			...
			case 1:
				...
				TimeManager.Instance.StartTime = new System.TimeSpan(10, 0, 0);
				break;
			...
			case 2:
				...
				TimeManager.Instance.StartTime = new System.TimeSpan(12, 0, 0);
				break;
